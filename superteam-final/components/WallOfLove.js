...
const HARDCODED_TWEETS = [
  { name: 'Lam', handle: '@LamWeb3', org: 'Web3 Builder', text: "I've been to ETHGlobal hackathons in Tokyo, Lisbon, Buenos Aires, and some other locations. I know what a well-run Web3 community looks like. Last month I sat in a @SuperteamMY outpost at Network School in Forest City, Malaysia. No panels. No sponsors on stage. Just builders talking honestly about what they're working on. That's when I realized Malaysia's Web3 infrastructure is further along than most people think.", image: '/wall/lam.jpeg', url: 'https://x.com/LamWeb3/status/2027588155965358149' },
  { name: 'Button', handle: '@nftbutton', org: 'Builder', text: "@SuperteamMY has honestly been one of the most welcoming builder communities I've experienced in Southeast Asia. Not hype. Not noise. Just real people building on Solana.", image: '/wall/button.jpeg', url: 'https://x.com/nftbutton/status/2027602414992560590' },
  { name: 'Circle', handle: '@decircusmaster', org: 'Community Member', text: "Peek @jemmmyjemm sharing the @MonkeDAO playbook at @ns Solana Outpost. Amazing event put together by @SuperteamMY!", image: '/wall/circle.jpeg', url: 'https://x.com/decircusmaster/status/2015710932853539029' },
  { name: 'Amit Kumar', handle: '@amitkumar0331', org: 'Grovio AI', text: "AI thinks as you do, and @GrovioAI executes on your behalf. Amazing demo day during @SuperteamMY & @ns where we showcased how marketing works in the AI era! Grateful for the community & amazing events.", image: '/wall/amit.jpeg', url: 'https://x.com/amitkumar0331/status/2016021153077498137' },
];
