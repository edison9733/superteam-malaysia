...
export default function Footer({ twitterUrl, telegramUrl, discordUrl }) {
  return (
    <footer style={{ position: 'relative', overflow: 'hidden', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <div style={{ padding: '48px 24px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.04)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
            <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.25)' }}>&copy; 2026 Superteam Malaysia. Part of the Superteam network.</span>
            <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.15)' }}>Designed & Built by edison9733 for Superteam Earn Bounty</span>
      ...
      {/* Giant partially-clipped SUPERTEAM text at the bottom */}
      <div style={{
        position: 'relative', overflow: 'hidden', height: 'clamp(80px, 15vw, 160px)',
        display: 'flex', alignItems: 'flex-end', justifyContent: 'center',
        marginTop: -10,
      }}>
        <span style={{
          fontSize: 'clamp(100px, 20vw, 280px)', fontWeight: 900, letterSpacing: '-0.04em',
          color: 'transparent',
