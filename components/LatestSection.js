...
const LATEST_TWEETS = [
  ...
  { name: 'Henry Lee', handle: '@Henryleemr', text: 'Proud to announce — Superteam Malaysia has grown to 3,400+ community members. From hackathons to Solana Hub. This is just the beginning. 🚀', image: '/gallery/event-7.jpg', url: 'https://x.com/Henryleemr' },
];
...
function LatestCard({ t, span }) {
  ...
  return (
    ...
    >
      {t.image && (
        <div style={{ height: span >= 8 ? 240 : 160, overflow: 'hidden' }}>
      ...
      <div style={{ padding: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
          <div style={{
            ...
            fontSize: 14, fontWeight: 700, color: '#14F195',
...
export default function LatestSection({ tweets: propTweets }) {
  const spans = [8, 4, 4, 8, 12];

  return (
    <section id="latest" className="scroll-spy-section" style={{ padding: '100px 24px', maxWidth: 1100, margin: '0 auto' }}>
